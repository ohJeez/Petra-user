...
import { TagIcon, PhotoIcon, HeartIcon } from '@heroicons/react/24/outline'
      ...
      <div className="space-y-6">
        <div className="input-group">
          <div className="input-wrapper">
            <HeartIcon className="input-icon w-5 h-5" />
            <Field 
              type="text"
              name="petName" 
          ...
          {showErrors && <ErrorMessage name="petName" component="div" className="form-error" />}
        </div>
